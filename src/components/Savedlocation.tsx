...
const Savedlocation = () => {
  ...
  const checkActiveLocation = (city: string) => {
  ...
  const removeLocation = (city: string) => {
    const newAll = allSaves.filter((each: any) => each.city !== city);
    if (city === activeLocation) {
    ...
    <div className="p-4 pt-0">
      <div className="flex items-center justify-between font-semibold z-10 py-4 sticky top-20 bg-white">
        ...
        <button
          ...
          className="flex items-center bg-sky-400 hover:bg-sky-500 py-2 px-4 text-gray-100 rounded-md"
        >
          ...
          allSaves.map((location: any) => (
            ...
            >
              ...
              <div className="flex gap-4 items-center">
                ...
                <button
                  className="flex items-center py-2 px-4 text-gray-100 rounded-md gap-2 bg-red-400 hover:bg-red-500"
